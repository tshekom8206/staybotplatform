...
{
    /// <inheritdoc />
    public partial class AddProactiveMessaging : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Drop FAQs table only if it exists (it may have been dropped in a previous deployment)
            migrationBuilder.Sql("DROP TABLE IF EXISTS \"FAQs\" CASCADE;");
            ...
            migrationBuilder.CreateTable(
                name: "ProactiveMessageSettings",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TenantId = table.Column<int>(type: "integer", nullable: false),
                    CheckinDayEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    MidStayEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    PreCheckoutEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    PostStayEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    CheckinDayTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    MidStayTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    PreCheckoutTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    PostStayTime = table.Column<TimeSpan>(type: "interval", nullable: false),
                    WelcomeImageUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    IncludePhotoInWelcome = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProactiveMessageSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProactiveMessageSettings_Tenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduledMessages_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduledMessages_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProactiveMessageSettings_TenantId",
                table: "ProactiveMessageSettings",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduledMessages_BookingId",
                table: "ScheduledMessages",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduledMessages_TenantId",
                table: "ScheduledMessages",
                column: "TenantId");
        }
