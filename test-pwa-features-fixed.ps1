...
function Test-ProductionBuild {
    ...
    $distPath = "apps\adminui\dist\staybot-admin\browser"
...
function Test-ServiceWorkerConfig {
    ...
    $ngsWConfigPath = "apps\adminui\dist\staybot-admin\browser\ngsw.json"
...
function Test-ManifestConfig {
    ...
    $manifestPath = "apps\adminui\dist\staybot-admin\browser\manifest.webmanifest"
...
function Test-PwaIcons {
    ...
    $iconsPath = "apps\adminui\dist\staybot-admin\browser\icons"
